const NavigationSidebar = (active) => {
   ...
   <div class="list-group">
            ...
            <a href="../home/index.html" class="list-group-item ${home}"><i class="fa fa-home pe-3"></i><span class="d-none d-xl-inline-block">Home</span></a>
            <a href="#" class="list-group-item ${explore}"><i class="fa fa-hashtag pe-3"></i><span class="d-none d-xl-inline-block">Explore</span></a>
